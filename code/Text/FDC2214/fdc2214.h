...
/*
//IO方向设置
#define FDC_SDA_IN()  {GPIOB->CRH&=0X0FFFFFFF;GPIOB->CRH|=(u32)8<<4*7;}
#define FDC_SDA_OUT() {GPIOB->CRH&=0X0FFFFFFF;GPIOB->CRH|=(u32)3<<4*7;}

//IO操作函数	 
#define FDC_IIC_SCL    PBout(14) 	//SCL
#define FDC_IIC_SDA    PBout(15)   //输出SDA	 
#define FDC_READ_SDA   PBin(15) 		//输入SDA 
*/

#define FDC_SDA_IN()  {GPIOB->CRH&=0XFFFFFF0F;GPIOB->CRH|=(u32)8<<4*1;}
#define FDC_SDA_OUT() {GPIOB->CRH&=0XFFFFFF0F;GPIOB->CRH|=(u32)3<<4*1;}

//IO操作函数	 
#define FDC_IIC_SCL    PBout(8) 	//SCL
#define FDC_IIC_SDA    PBout(9)   //输出SDA	 
#define FDC_READ_SDA   PBin(9) 		//输入SDA 
...
unsigned long FilteredFCD2214ReadCH(unsigned char index);
